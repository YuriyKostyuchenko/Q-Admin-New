...
! function(s) {
    "use strict";
    var t, e, n, r, i, o, a, f, u = tinymce.util.Tools.resolve("tinymce.PluginManager"),
        c = function() {},
        l = function(t) {
            return function() {
                return t
        ...
        C = (I(Array.from) && Array.from, function() {
    ...
    i = undefined, o = P, a = E, f = undefined,
        function(t) {
            "object" == typeof o && void 0 !== a ? a.exports = t() : "function" == typeof i && i.amd ? i([], t) : ("undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this).EphoxContactWrapper = t()
        }(function() {
    ...
    var L = E.exports.boltExport,
        ...
        Z = function(t) {
            ...
            return O([
                ...
                [{
                    type: "grid",
                    columns: 2,
                    items: O([n.toArray(), t.hasImageCaption ? [{
                        type: "label",
                        label: "Caption",
                        items: [{
                            type: "checkbox",
        ...
        at = function(t, e) {
            ...
            n.onload = function() {
                var t = {
                    width: ot(n.width, n.clientWidth),
                    height: ot(n.height, n.clientHeight)
                };
                r(M.value(t))
            }, n.onerror = function() {
            ...
            var i = n.style;
            i.visibility = "hidden", i.position = "fixed", i.bottom = i.left = "0px", i.width = i.height = "auto", s.document.body.appendChild(n), n.src = t
        },
        ut = function(t) {
        ...
        ft = function(t, e, n) {
            ...
            n.onload = function() {
                e.width || e.height || !it.hasDimensions(t) || t.dom.setAttribs(n, {
        ...
        pt = Y.DOM,
        gt = function(t) {
            return t.style.marginLeft && t.style.marginRight && t.style.marginLeft === t.style.marginRight ? ut(t.style.marginLeft) : ""
        },
        ht = function(t) {
            return t.style.marginTop && t.style.marginBottom && t.style.marginTop === t.style.marginBottom ? ut(t.style.marginTop) : ""
        },
        yt = function(t) {
        ...
        _t = function(t) {
            var e, n, r, i;
            wt(t) ? (i = (r = t).parentNode, pt.insertAfter(r, i), pt.remove(i)) : (e = t, n = pt.create("figure", {
                "class": "image"
            }), pt.insertAfter(n, e), n.appendChild(e), n.appendChild(pt.create("figcaption", {
        ...
        Pt = function(t, e) {
            var n = s.document.createElement("img");
            return Tt(n, "style", e.style), (gt(n) || "" !== e.hspace) && It(n, e.hspace), (ht(n) || "" !== e.vspace) && St(n, e.vspace), (yt(n) || "" !== e.border) && Dt(n, e.border), (bt(n, "borderStyle") || "" !== e.borderStyle) && Ot(n, e.borderStyle), t(n.getAttribute("style"))
        },
        Et = function(t, e) {
            return {
                src: vt(e, "src"),
        ...
        jt = function(t, e, n) {
            ...
            Lt(n, r, e, "caption", function(t, e, n) {
                return _t(t)
            }), Lt(n, r, e, "src", Tt), Lt(n, r, e, "alt", Tt), Lt(n, r, e, "title", Tt), Lt(n, r, e, "width", xt(0, t)), Lt(n, r, e, "height", xt(0, t)), Lt(n, r, e, "class", Tt), Lt(n, r, e, "style", Nt(function(t, e) {
                return Tt(t, "style", e)
            }, t)), Lt(n, r, e, "hspace", Nt(It, t)), Lt(n, r, e, "vspace", Nt(St, t)), Lt(n, r, e, "border", Nt(Dt, t)), Lt(n, r, e, "borderStyle", Nt(Ot, t))
        },
        Rt = function(t, e) {
        ...
        zt = function(e, t) {
            var n = function(t, e) {
                ...
                if (jt(t, X(e, {
                        caption: !1
                    }), n), Tt(n, "alt", e.alt), e.caption) {
                    var r = pt.create("figure", {
                        "class": "image"
                    });
                    return r.appendChild(n), r.appendChild(pt.create("figcaption", {
                        contentEditable: "true"
        ...
        Ht = function(t, e) {
            ...
            n ? e.src ? function(e, t) {
                ...
                if (jt(function(t) {
                        return Rt(e, t)
                    }, t, r), n = r, e.dom.setAttrib(n, "src", n.getAttribute("src")), Ct(r.parentNode)) {
                    var i = r.parentNode;
        ...
        qt = function(t, n) {
            return function(t, e) {
                ...
                return e = t, Object.prototype.hasOwnProperty.call(e, "items") ? qt(t.items, n) : t.value === n ? w.some(t) : w.none();
                var e
            })
        },
        $t = Wt,
    ...
    function Xt(a) {
        var e = function(t, r, i, e) {
            var o, n;
            (o = new s.XMLHttpRequest).open("POST", a.url), o.withCredentials = a.credentials, o.upload.onprogress = function(t) {
                e(t.loaded / t.total * 100)
            }, o.onerror = function() {
                i("Image upload failed due to a XHR Transport error. Code: " + o.status)
            }, o.onload = function() {
                var t, e, n;
                o.status < 200 || 300 <= o.status ? i("HTTP Error: " + o.status) : (t = JSON.parse(o.responseText)) && "string" == typeof t.location ? r((e = a.basePath, n = t.location, e ? e.replace(/\/$/, "") + "/" + n.replace(/^\//, "") : n)) : i("Invalid JSON: " + o.responseText)
            }, (n = new s.FormData).append("file", t.blob(), t.filename()), o.send(n)
        };
        return a = Bt.extend({
            credentials: !1,
            handler: e
            ...
            upload: function(t) {
                return a.url || a.handler !== e ? (r = t, i = a.handler, new tt(function(t, e) {
                    try {
                        i(r, t, e, c)
                    } catch (n) {
                        e(n.message)
    ...
    var Zt = function(t) {
        ...
        ee = function(t, e) {
            var n, r, i = e.getData();
            (n = t, r = i.src.value, /^(?:[a-zA-Z]+:)?\/\//.test(r) ? w.none() : n.prependURL.bind(function(t) {
        ...
        ne = function(t, e) {
            var n, r, i, o = e.getData(),
                a = o.src.meta;
            if (a !== undefined) {
                var u = V({}, o);
                r = u, i = a, (n = t).hasDescription && _(i.alt) && (r.alt = i.alt), n.hasImageTitle && _(i.title) && (r.title = i.title), n.hasDimensions && (_(i.width) && (r.dimensions.width = i.width), _(i.height) && (r.dimensions.height = i.height)), _(i["class"]) && Vt(n.classList, i["class"]).each(function(t) {
                    r.classes = t.value
                }), n.hasImageCaption && A(i.caption) && (r.caption = i.caption), n.hasAdvTab && (_(i.vspace) && (r.vspace = i.vspace), _(i.border) && (r.border = i.border), _(i.hspace) && (r.hspace = i.hspace), _(i.borderstyle) && (r.borderstyle = i.borderstyle)), e.setData(u)
            }
        },
        re = function(t, e, n, r) {
            var i, o, a, u, c, l, s, f, d, m, p, g;
            ee(e, r), ne(e, r), i = t, o = e, a = n, c = (u = r).getData(), l = c.src.value, (s = c.src.meta || {}).width || s.height || !o.hasDimensions || i.imageSize(l).get(function(t) {
                t.each(function(t) {
                    a.open && u.setData({
                        dimensions: t
                    })
                })
            }), f = e, d = n, p = (m = r).getData(), g = Vt(f.imageList, p.src.value), d.prevImage = g, m.setData({
                images: g.map(function(t) {
                    return t.value
                }).getOr("")
            })
        },
        ie = function(t, e, n) {
            var r, i, o, a, u, c = lt(t(n.style)),
                l = V({}, n);
            return l.vspace = (r = c)["margin-top"] && r["margin-bottom"] && r["margin-top"] === r["margin-bottom"] ? ut(String(r["margin-top"])) : "", l.hspace = (i = c)["margin-right"] && i["margin-left"] && i["margin-right"] === i["margin-left"] ? ut(String(i["margin-right"])) : "", l.border = (o = c)["border-width"] ? ut(String(o["border-width"])) : "", l.borderstyle = (a = c)["border-style"] ? String(a["border-style"]) : "", l.style = (u = e)(t(u(c))), l
        },
        oe = function(a, u, c, l) {
            var t, e = l.getData();
            l.block("Uploading image"), (t = e.fileinput, 0 === t.length ? w.none() : w.some(t[0])).fold(function() {
                l.unblock()
            }, function(n) {
                ...
                dt(n).then(function(t) {
                    ...
                    i.upload(e).then(function(t) {
                        ...
                        }), l.showTab("general"), re(a, u, c, l), o()
                    })["catch"](function(t) {
                        o(), a.alertErr(l, t)
                    })
                })
        ...
        ae = function(h, y, v) {
            return function(t, e) {
                ...
                "src" === e.name ? re(h, y, v, t) : "images" === e.name ? (s = h, f = y, d = v, p = (m = t).getData(), (g = Vt(f.imageList, p.images)).each(function(t) {
                    "" === p.alt || d.prevImage.map(function(t) {
                        return t.text === p.alt
                    }).getOr(!1) ? "" === t.value ? m.setData({
                        src: t,
                        alt: d.prevAlt
                    }) : m.setData({
                        src: t,
                ...
                }), d.prevImage = g, re(s, f, d, m)) : "alt" === e.name ? v.prevAlt = t.getData().alt : "style" === e.name ? (a = h, c = (u = t).getData(), l = ie(a.parseStyle, a.serializeStyle, c), u.setData(l)) : "vspace" === e.name || "hspace" === e.name || "border" === e.name || "borderstyle" === e.name ? (n = h, r = t, i = V(Yt(y.image), r.getData()), o = Pt(n.normalizeCss, te(i)), r.setData({
                    style: o
        ...
        ue = function(o) {
            return function(t) {
                var e, n, r, i = {
                    prevImage: Vt((e = t).imageList, e.image.src),
                    prevAlt: e.image.alt,
                    open: !0
                };
                return {
                    ...
                    size: "normal",
                    body: (r = t, r.hasAdvTab || r.hasUploadUrl || r.hasUploadHandler ? {
                        type: "tabpanel",
                        tabs: O([
                            [K(r)], r.hasAdvTab ? [Zt(r)] : [], r.hasUploadTab && (r.hasUploadUrl || r.hasUploadHandler) ? [Qt(r)] : []
                        ])
                    } : {
                        type: "panel",
                        items: Q(r)
        ...
        ce = function(e) {
            var n, r, i, o, a, u, c, t = {
                onSubmit: (c = e, function(n) {
                    return function(t) {
                        var e = V(Yt(n.image), t.getData());
                        c.undoManager.transact(function() {
                            Ht(c, te(e))
                        }), c.editorUpload.uploadImagesAuto(), t.close()
                    }
                }),
                imageSize: (u = e, function(t) {
                    return q(function(n) {
                ...
                createBlobCache: (a = e, function(t, e, n) {
                ...
                alertErr: (o = e, function(t, e) {
                    o.windowManager.alert(e, t.close)
                }),
                normalizeCss: (i = e, function(t) {
                    return Rt(i, t)
                }),
                parseStyle: (r = e, function(t) {
                    return r.dom.parseStyle(t)
                }),
                serializeStyle: (n = e, function(t, e) {
                    return n.dom.serializeStyle(t, e)
                })
            };
            return {
                open: function() {
                    return Kt(e).map(ue(t)).get(function(t) {
        ...
        se = function(o) {
            return function(t) {
                for (var e, n = t.length, r = function(t) {
                        t.attr("contenteditable", o ? "true" : null)
                    }; n--;) {
                    var i = t[n];
                    void 0, (e = i.attr("class")) && /\bimage\b/.test(e) && (i.attr("contenteditable", o ? "false" : null), Bt.each(i.getAll("figcaption"), r))
                }
            }
        },
        fe = function(t) {
