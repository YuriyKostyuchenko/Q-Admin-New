...
(function (global, factory) {
  ...
  var editable = renderer.create('<div class="note-editable card-block zzz" contentEditable="true" role="textbox" aria-multiline="true"/ style="min-height:1000px">');
  ...
  $$1.summernote = $$1.extend($$1.summernote, {
      ...
      options: {
          ...
          icons: {
              ...
              'rowBelow': 'fas fa-row-below',
              'colBefore': 'fas fa-col-before',
              'colAfter': 'fas fa-col-after',
              'rowAbove': 'fas fa-row-above',
              'rowRemove': 'fas fa-row-remove',
              'colRemove': 'fas fa-col-remove',
...
//# sourceMappingURL=_summernote-bs4.js.map
